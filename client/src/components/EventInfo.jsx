...
const EventInfo = ({ eventId }) => {
  ...
  const handleAddVolunteer = async (e) => {
    e.preventDefault();
    try {
      if (!newVolunteer.email || !newVolunteer.role) {
      toast.error("Please fill all volunteer fields");
      return;
       }
      ...
      if (res.data.success) {
        ...
        toast.error(res.data.message || "Error adding volunteer");
      }
    } catch (err) {
    ...
    <div className="p-4 mt-4 space-y-6">
      ...
      <div className="bg-gray-100 shadow-md rounded-xl p-5 hover:shadow-lg transition">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-gray-700">
          ...
          <div>
            <strong>Venue:</strong> {event.location?.venue || "Not specified"}
          </div>
          <div>
